...
namespace GenC.Web.Controllers
{
    ...
    {
        protected DbContextGenC db;
        protected string GoogleMapsKey;

        public baseController()
        {
            db = new DbContextGenC();
            GoogleMapsKey = System.Configuration.ConfigurationManager.AppSettings["GoogleMaps"].ToString();
        }
        ...
        protected void SessionCookies(Usuarios user)
        {
            ...
            WriteCookie("Username", user.Email.ToString());
            WriteCookie("Name", user.Nome.ToString());
